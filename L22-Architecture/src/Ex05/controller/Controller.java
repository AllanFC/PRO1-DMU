...
public class Controller {
    ...
    public static void setCompanyCustomers(ArrayList<Customer> customers, Company company){
    ...
    public static ArrayList<Customer> getCustomersOfCompany(Company company){
