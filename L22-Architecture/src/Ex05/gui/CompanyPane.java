...
public class CompanyPane extends GridPane {
    ...
    public CompanyPane() {
        ...
        Button btnAddCustomer = new Button("Add customers");
    ...
    private void addCustomerAction(){
        ...
        if(company != null) {
            CustomerCompanyWindow dialog = new CustomerCompanyWindow("Add customers to " + company, company);
            dialog.showAndWait();
        }
    ...
    private void createCustomerAction(){
        ...
        CustomerWindow dialog = new CustomerWindow("Update Company", company);
        dialog.showAndWait();
